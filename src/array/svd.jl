...
#
# `@nospecialize` on the vararg keeps a single compiled instance regardless of
# how many tiles a worker owns; the inner kernels still dispatch to concrete,
# BLAS-backed methods.
