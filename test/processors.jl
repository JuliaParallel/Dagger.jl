...
@testset "Processors" begin
    ...
    @testset "Processor exhaustion" begin
        ...
        @test_throws_unwrap (Dagger.ThunkFailedException, Dagger.Sch.SchedulingException) ex.reason="No processors available, try widening scope" collect(delayed(sum; options=opts)([1,2,3]))
